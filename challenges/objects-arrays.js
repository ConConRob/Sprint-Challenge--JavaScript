...
console.log(`${tyrannosaurus.name} weighed ${tyrannosaurus.weight}kg.`);

// What was the diet of a velociraptor?
console.log(`${velociraptor.name} are ${velociraptor.diet}.`);

// How long was a stegosaurus?
console.log(`${stegosaurus.name} are ${stegosaurus.length}m long.`);

// What time period did tyrannosaurus live in?
console.log(`${tyrannosaurus.name} came from the ${tyrannosaurus.period} period.`);
